...
│   ├── FRAMEWORK_DESIGN.md             # Framework design summary
│   ├── DEPLOYMENT_CHECKLIST.md         # Deployment verification
│   ├── STATUS_TEMPLATE.md              # Status tracking template
│   └── artifacts/                      # (Created dynamically per User Story)
...
- Agent definitions: `.github/copilot/<phase>-agent.instructions.md`
- Phase prompts: `.github/prompts/<phase>.md`
- Orchestrator: `.github/workflows/orchestrator.md`

**Documentation (`docs/`):**
- Framework guide: `docs/README.md`
- Quick start: `docs/QUICKSTART.md`
- Design details: `docs/FRAMEWORK_DESIGN.md`
- Deployment: `docs/DEPLOYMENT_CHECKLIST.md`
- Status template: `docs/STATUS_TEMPLATE.md`

**Artifacts (`docs/artifacts/`):**
- Per-story artifacts: `docs/artifacts/<USER_STORY_ID>/<phase>.md`
- Status tracker: `docs/artifacts/<USER_STORY_ID>/status.md`
